...
class FragmentIngresosForm : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_fragment_ingresos_form, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentIngresosForm.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentIngresosForm().apply {
